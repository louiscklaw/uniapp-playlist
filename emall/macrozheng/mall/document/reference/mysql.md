...
- 授予所有数据库的所有权限(包括grant)：grant all privileges on _._ to z1@localhost with grant option
- 授予SUPER PROCESS FILE权限：grant super,process,file on _._ to z3@localhost
