...
public class MemberAttentionController {
  ...
  public CommonResult add(
    @RequestBody MemberBrandAttention memberBrandAttention
  ) {
  ...
  public CommonResult<CommonPage<MemberBrandAttention>> list(
    ...
    Page<MemberBrandAttention> page = memberAttentionService.list(
      pageNum,
      pageSize
    );
  ...
  public CommonResult<MemberBrandAttention> detail(@RequestParam Long brandId) {
    MemberBrandAttention memberBrandAttention = memberAttentionService.detail(
      brandId
    );
