...
public class HomeController {
  ...
  public CommonResult<List<PmsProduct>> recommendProductList(
    ...
    List<PmsProduct> productList = homeService.recommendProductList(
      pageSize,
      pageNum
    );
  ...
  @RequestMapping(
    value = "/productCateList/{parentId}",
  ...
  public CommonResult<List<CmsSubject>> getSubjectList(
    ...
    List<CmsSubject> subjectList = homeService.getSubjectList(
      cateId,
      pageSize,
      pageNum
    );
  ...
  public CommonResult<List<PmsProduct>> hotProductList(
    ...
    List<PmsProduct> productList = homeService.hotProductList(
      pageNum,
      pageSize
    );
    return CommonResult.success(productList);
  ...
  public CommonResult<List<PmsProduct>> newProductList(
    ...
    List<PmsProduct> productList = homeService.newProductList(
      pageNum,
      pageSize
    );
    return CommonResult.success(productList);
