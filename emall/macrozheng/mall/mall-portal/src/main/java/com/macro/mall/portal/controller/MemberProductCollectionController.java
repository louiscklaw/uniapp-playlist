...
public class MemberProductCollectionController {
  ...
  public CommonResult add(
    @RequestBody MemberProductCollection productCollection
  ) {
  ...
  public CommonResult<CommonPage<MemberProductCollection>> list(
    ...
    Page<MemberProductCollection> page = memberCollectionService.list(
      pageNum,
      pageSize
    );
  ...
  @ResponseBody
  public CommonResult<MemberProductCollection> detail(
    @RequestParam Long productId
  ) {
    MemberProductCollection memberProductCollection = memberCollectionService.detail(
      productId
    );
