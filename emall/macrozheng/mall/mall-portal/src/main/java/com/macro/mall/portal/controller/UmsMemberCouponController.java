...
public class UmsMemberCouponController {
  ...
  public CommonResult<List<SmsCouponHistory>> listHistory(
    ...
    List<SmsCouponHistory> couponHistoryList = memberCouponService.listHistory(
      useStatus
    );
  ...
  public CommonResult<List<SmsCouponHistoryDetail>> listCart(
    ...
    List<SmsCouponHistoryDetail> couponHistoryList = memberCouponService.listCart(
  ...
  public CommonResult<List<SmsCoupon>> listByProduct(
    ...
    List<SmsCoupon> couponHistoryList = memberCouponService.listByProduct(
      productId
    );
    return CommonResult.success(couponHistoryList);
  }
